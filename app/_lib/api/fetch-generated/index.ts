 ...
 * Treino API
 * API para treino do Diogão
 * OpenAPI spec version: 1.0.0
 */
import { customFetch } from "../../fetch";
export type ListWorkouPlanParams = {
  active?: ListWorkouPlanActive;
};

export type ListWorkouPlanActive =
  (typeof ListWorkouPlanActive)[keyof typeof ListWorkouPlanActive];

export const ListWorkouPlanActive = {
  true: "true",
  false: "false",
} as const;

export type ListWorkouPlan200ItemWorkoutDaysItemWeekDay =
  (typeof ListWorkouPlan200ItemWorkoutDaysItemWeekDay)[keyof typeof ListWorkouPlan200ItemWorkoutDaysItemWeekDay];

export const ListWorkouPlan200ItemWorkoutDaysItemWeekDay = {
  SUNDAY: "SUNDAY",
  MONDAY: "MONDAY",
  TUESDAY: "TUESDAY",
  WEDNESDAY: "WEDNESDAY",
...
export type ListWorkouPlan200ItemWorkoutDaysItemExercisesItem = {
...
export type ListWorkouPlan200ItemWorkoutDaysItem = {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  name: string;
  weekDay: ListWorkouPlan200ItemWorkoutDaysItemWeekDay;
  isRest: boolean;
  estimatedDurationInSeconds: number;
  coverImageUrl?: string;
  exercises: ListWorkouPlan200ItemWorkoutDaysItemExercisesItem[];
};

export type ListWorkouPlan200Item = {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  name: string;
  isActive: boolean;
  workoutDays: ListWorkouPlan200ItemWorkoutDaysItem[];
};

export type ListWorkouPlan401 = {
  error: string;
  code: string;
};

export type ListWorkouPlan500 = {
  error: string;
  code: string;
};
 ...
 */
export type listWorkouPlanResponse200 = {
  data: ListWorkouPlan200Item[];
  status: 200;
};

export type listWorkouPlanResponse401 = {
  data: ListWorkouPlan401;
  status: 401;
};

export type listWorkouPlanResponse500 = {
  data: ListWorkouPlan500;
  status: 500;
};

export type listWorkouPlanResponseSuccess = listWorkouPlanResponse200 & {
  headers: Headers;
};
export type listWorkouPlanResponseError = (
  | listWorkouPlanResponse401
  | listWorkouPlanResponse500
) & {
  headers: Headers;
};

export type listWorkouPlanResponse =
  | listWorkouPlanResponseSuccess
  | listWorkouPlanResponseError;

export const getListWorkouPlanUrl = (params?: ListWorkouPlanParams) => {
...
export const listWorkouPlan = async (
  params?: ListWorkouPlanParams,
  options?: RequestInit,
): Promise<listWorkouPlanResponse> => {
  return customFetch<listWorkouPlanResponse>(getListWorkouPlanUrl(params), {
    ...options,
    method: "GET",
  });
};
